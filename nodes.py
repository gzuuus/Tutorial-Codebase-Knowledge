...
- Begin with a high-level motivation explaining what problem this abstraction solves{instruction_lang_note}. Start with a central use case as a concrete example. The whole chapter should guide the reader to understand how to solve this use case. Make it very minimal.
...
- Then dive deeper into code for the internal implementation with references to files. Explain{instruction_lang_note}.
...
Now, directly provide a Markdown output (DON'T need ```markdown``` tags):
"""
